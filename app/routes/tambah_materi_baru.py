...
tambah_materi_baru = Blueprint('tambah_materi_baru', __name__)


@tambah_materi_baru.route('/tambah_materi_baru/<_id_kelas>', methods=['POST'])
def tambah_materi_baruu(_id_kelas):
        ...
        try:
            ...
            current_app.db.menumateri.insert_one(doc_materi)
            msg = 'tambah_materi'
